...
const Dashboard = () => {
 ...
 <div className='Hamburger-Container'>
      <div className='left-hamburger'>
        ...
        <ul>
          <li className='d-list'>
            <a className='d-board'><img src={Dboard} alt="Dashboard" />Dashboard</a>
          </li>

          <li className='d-list' onClick={() => toggleDropdown('vehicle')}>
    ...
    <a>Vehicle Management</a>
          ...
          <li className='d-list' onClick={() => toggleDropdown('booking')}>
