...
const dropdownRef= useRef();
  const options = [
    ...
    const renderScheduleContent = () => {
      if (view === 'day') {
        return <div className='schedule-head'>Day Schedule: Show today's appointments/camps</div>;
      } else if (view === 'week'){
        return <div className='schedule-head'>Week Schedule: Show weekly overview</div>;
      }
      else{
        return <div className='schedule-head'>Month Schedule: Show Monthly overview</div>;
      }
    };
 ...
 <div className="trip-content">
      ...
      <div className='Schedule-container'>
        {renderScheduleContent()}
            ...
            <div className='CarDriverAva-container'><h2 className='car-head'> Car and Driver Availablity</h2></div>
